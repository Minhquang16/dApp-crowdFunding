...
const NavBar = () => {
  ...
  return (
    <div className="backgroundMain ">
      <div className="px-4 py-5 mx-auto sm:smax-w-xl md:max-w-full lg:max-screen-xl md:px-24 lg:px-8">
        ...
        <div className="lg:hidden z-40 flex justify-end">
          <button
              ...
              <div className="p-5 bg-white border rounded shadow-sm">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <button
                    ...
                    title="Close Menu"
                    className="p-2 -mt-2 transition duration-200 rounded hover:bg-gray-200
                  ...
                  >
                    <svg className="w-5 text-gray-600" viewBox="0 0 24 24">
                       <path
                        ...
                        0s-0.4,1,0,1.4l6.3,6.3l-6.3,6.3 c-0.4,0.4-0.4,1,0,1.4C4.5,19.9,4.7,20,5,
                        20s0.5-0.1,0.7-0.3l6.3-6.3l6.3,6.3c0.2,0.2,0.5,0.3,0.7,0.3s0.5-0.1,0.7-0.3 
