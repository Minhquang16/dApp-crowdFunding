...
//                         <button
//                         className="p-1 ml-auto bg-tranparent border-0 text-black opacity-5
//                         float-right text-3xl leading-none font-semibold outline-none
//                         focus:outline-none"
//                         onClick={() => setOpenModel(false)}>
//                             <span className="bg-transparent text-black opacity-5 h-6
//                             w-6 text-2xl block ountline-none focus:outline-none">x</span>
//                         </button>
//                     </div>
//                     {/* body */}
...
//                         required
//                         type="text"
//                         className="flex-grow w-full h-12 px-4 mb-2 trasition duration-200
...
//                         type="button"
//                         onClick={()=>setOpenModel(false)}>Close</button>
//                         <button
//                         className="bg text-white active:bg-emerald-600 font-bold
//                         uppercase text-sm px-6 py-3 rounded shadow hover:shadow-lg outline-none
//                         focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150"
//                         type="button"
//                         onClick={()=> createDonation()}>Donate</button>
//                     </div>
//                 </div>
//                 </div>
//             </div>
