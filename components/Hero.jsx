    ...
    return (
        <div className="relative">
            ...
            <div className="relative bg-opacity-75 backgroundMain">
                ...
                162.5 916 162.5C796 162.5 676 162.5 556 162.5 316 162.5 196 162.5C76 
                162.5 -44 162.5 -104 162.5 -104 162.5H-164V13Z"/>
                </svg>
             ...
             md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
                <div className="flex flex-col items-center justify-between xl:flex-row">
                    <div className="w-full max-w-xl mb-12 xl:mb-0 xl:pr-16 xl:w-7/12">
                        ...
                        <p className="ma-w-xl mb-4 text-base text-gray-200 md:text-lg">
                    ...
                    <div className="w-full max-w-xl xl:px-8 xl:w-5/12">
                        ...
                        <h3 className="mb-4 text-xl font-semibol sm:text-center sm:mb-6
                        sm:text-2xl">
                            Campaign
                        </h3>
                        <form>
                            <div className="mb-1 sm:mb-2">
                                ...
                                duration-200 bg-white border-gray-300 rounded shadow-sm
